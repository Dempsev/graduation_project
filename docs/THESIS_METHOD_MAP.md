...
| real validation | The MATLAB + COMSOL execution that checks whether shortlisted candidates are physically valid target-band designs | `runners/run_stage4_validation_targetband_top6_v1.m`, `stage4_validation/run_stage4_validation_from_manifest.m` | `data/comsol_batch/stage4_validation_targetband_top6_v1/` |
