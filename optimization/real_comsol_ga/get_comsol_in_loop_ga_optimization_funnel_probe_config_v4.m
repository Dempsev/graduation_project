function cfg = get_comsol_in_loop_ga_optimization_funnel_probe_config_v4()
%GET_COMSOL_IN_LOOP_GA_OPTIMIZATION_FUNNEL_PROBE_CONFIG_V4
% Efficiency-first v4 probe:
% - keep v1's strong high-recall probe budget
% - use the updated optimization seed ranking that now includes optimization memory
% - sort by optimization prior before weaker historical heuristics.

cfg = get_comsol_in_loop_ga_config_v1();
cfg.gaId = 'comsol_in_loop_ga_optimization_funnel_probe_v4';
...
cfg.topKSeeds = 20;
cfg.seedSortFields = {'optimization_seed_score','optimization_best_real_gain_Hz','historical_best_real_gain_Hz','contact_prob','positive_prob','surrogate_pred_gap34_gain_Hz','stage1_reference_gap_gain_Hz'};
cfg.seedSortDirections = {'descend','descend','descend','descend','descend','descend','descend'};
...
signatureParts = [ ...
    ...
    { ...
    'optimization_mode=funnel_probe_v4', ...
    ['seed_scored_csv=' file_signature_v1(cfg.seedScoredCsv)], ...
    'seed_sort=v4_optimization_memory_first', ...
