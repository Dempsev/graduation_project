...
def run() -> int:
    ...
    out_png = (
        ...
        / "thesis_ch2_v1"
        / "figures"
        / "ch2_snake_fourier_overlay_mesh_ep100_step18.png"
    )
    ...
    try:
        ...
        matlab_expr = (
            ...
            "export_ch2_snake_fourier_overlay_mesh_v1"
        )
        ...
        if not out_png.exists():
            print(f"[ERROR] expected PNG was not created: {out_png}", file=sys.stderr, flush=True)
            return 2
