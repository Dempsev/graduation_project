...
TARGET = ROOT / 'prediction_targetband_param_v1' / 'tools' / 'build_curated_application_bundle_v1.py'
DEFAULT_ARGS = [
    '--config',
    str(ROOT / 'prediction_targetband_param_v1' / 'configs' / 'curated_band_catalog_thesis_v2.json'),
