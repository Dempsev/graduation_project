...
def main() -> None:
    ...
    parser.add_argument(
        "--freeze-config",
        default=str(ROOT / "prediction_targetband_param_v1" / "configs" / "targetband_mainline_freeze_v1.json"),
    )
    parser.add_argument(
        "--out-dir",
    ...
    cls_run_root = ROOT / "data" / "prediction_targetband_param_v1_runs" / freeze_cfg["frozen_mainline"]["classifier_run_name"]
    reg_run_root = ROOT / "data" / "prediction_targetband_param_v1_runs" / freeze_cfg["frozen_mainline"]["regressor_run_name"]
    ...
    readiness_summary = {
        ...
        "dataset_tag": freeze_cfg["frozen_mainline"]["default_dataset_tag"],
        "classifier_run": freeze_cfg["frozen_mainline"]["classifier_run_name"],
        "regressor_run": freeze_cfg["frozen_mainline"]["regressor_run_name"],
