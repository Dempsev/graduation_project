...
def generate_coverage_summary() -> Path:
    ...
    catalog = ROOT / "prediction_targetband_param_v1" / "configs" / "thesis_band_catalog_v2.json"
    run_step(
        "prediction_targetband_param_v1/tools/analyze_band_coverage_v1.py",
        "--dataset",
        str(dataset),
        "--catalog",
        str(catalog),
...
def generate_weak_band_dashboard() -> Path:
    run_step("prediction_targetband_param_v1/tools/analyze_weak_band_dashboard_v1.py")
    return ROOT / "data" / "analysis" / "weak_band_dashboard_v1" / "weak_band_dashboard_summary_v1.csv"


def generate_local_robustness() -> Path:
    run_step("prediction_targetband_param_v1/tools/analyze_canonical_local_robustness_v1.py")
    run_step("prediction_targetband_param_v1/tools/plot_canonical_local_robustness_edges_v1.py")
