...
DEFAULT_DATASET = ROOT / 'data' / 'pure_prediction_v5' / 'v1' / 'pure_bandgap_regression_v5.csv'
DEFAULT_OUT_ROOT = ROOT / 'data' / 'pure_prediction_v5_runs'
TARGET_CHOICES = PURE_REGRESSION_TARGET_CHOICES


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train a pure-structural RandomForest regressor on the corrected-label v5 dataset.')
    ...
    parser.add_argument('--run-name', default='rf_gap34width_v5')
...
def main() -> None:
    ...
    if not feature_cols:
        raise RuntimeError('No usable feature columns found for v5 RandomForest regressor.')
    ...
    print('[DONE] prediction_v5 RandomForest training complete')
