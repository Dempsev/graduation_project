...
from prediction_targetband_param_v1.models.inference import (
    build_targetband_prediction_frame,
)

HOLDOUT_CSV = ROOT / 'data' / 'prediction_targetband_param_v1' / 'v1' / 'windows_dense_v9_active_ga_mid_aug_v1' / 'active_ga_fullcover_holdout_rows_v1.csv'
OUT_DIR = ROOT / 'data' / 'analysis' / 'targetband_active_learning_v9'

RUNS = {
    'v8_before_active_ga': {
        'classifier': ROOT / 'data' / 'prediction_targetband_param_v1_runs' / 'param_targetband_cls_rf_dense_v8_cmp_v1' / 'stratified_group_kfold',
        'regressor': ROOT / 'data' / 'prediction_targetband_param_v1_runs' / 'param_targetband_cover_hgb_dense_v8_cmp_v1' / 'stratified_group_kfold',
    },
    'v9_after_midtrajectory_aug': {
