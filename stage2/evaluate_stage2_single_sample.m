function result = evaluate_stage2_single_sample(cfg, candidateRow, pointSpec, refPoint)
%EVALUATE_STAGE2_SINGLE_SAMPLE Evaluate one candidate shape at one DOE point.
...
result = evaluate_stage2_case_internal(cfg, sampleMeta, pointSpec, refPoint);
end
