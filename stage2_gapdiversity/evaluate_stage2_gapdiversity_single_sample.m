function result = evaluate_stage2_gapdiversity_single_sample(cfg, candidateRow, pointSpec, refPoint)
%EVALUATE_STAGE2_GAPDIVERSITY_SINGLE_SAMPLE Evaluate one candidate shape at one exploration point.
...
result = evaluate_stage2_gapdiversity_case_internal(cfg, sampleMeta, pointSpec, refPoint);
end
