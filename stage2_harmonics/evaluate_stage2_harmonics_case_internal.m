function result = evaluate_stage2_harmonics_case_internal(cfg, sampleMeta, pointSpec, refPoint)
%EVALUATE_STAGE2_HARMONICS_CASE_INTERNAL Shared worker for harmonic cases.
...
try
    ...
    try
        ...
        warning('evaluate_stage2_harmonics_case_internal:BatchFallback', ...
    ...
    if ~isfile(tbl1Path)
        error('evaluate_stage2_harmonics_case_internal:MissingTbl1', 'Expected tbl1 export not found: %s', tbl1Path);
    end
