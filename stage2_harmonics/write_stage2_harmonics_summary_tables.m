function write_stage2_harmonics_summary_tables(resultsTable, cfg)
%WRITE_STAGE2_HARMONICS_SUMMARY_TABLES Export harmonic-screen summaries.
...
pointSummary = sortrows(pointSummary, {'mean_gap_gain_Hz','median_gap_gain_Hz'}, {'descend','descend'});
end

function row = make_shape_summary_row()
row = struct('candidate_id',string(""),'shape_id',string(""),'candidate_role',string(""),'shape_family',string(""), ...
    'points_total',0,'points_solved',0,'positive_gain_count',0,'positive_gain_ratio',NaN, ...
    'best_gap_gain_Hz',NaN,'mean_gap_gain_Hz',NaN,'median_gap_gain_Hz',NaN,'worst_gap_gain_Hz',NaN);
end
...
row = struct('main_id',string(""),'point_id',string(""), ...
    ...
    'shape_count',0,'positive_gain_count',0,'mean_gap_gain_Hz',NaN,'median_gap_gain_Hz',NaN);
end
