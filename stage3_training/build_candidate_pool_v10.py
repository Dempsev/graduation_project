...
# Keep the v10 seed-only line conservative by expanding only within a known rf09 neighborhood.
POINT_SPECS = [
    {
...
def build_candidate_pool(
    ...
    info = {
        ...
        'strategy': 'one best stage1-positive seed per never-stage4-validated family through v9, focused on the rf09 center point with the old rf09 anchor retained as a lightweight control arm',
    }
    return rows, info
