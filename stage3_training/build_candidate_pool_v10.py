...
# Keep the v10 seed-only line conservative by expanding only within a small trusted rf09 neighborhood.
POINT_SPECS = [
    {
...
def build_candidate_pool(
    ...
    for seed in seed_manifest:
        ...
        for point in point_specs:
            ...
            rows.append({
                'sample_id': f"candidate_pool_v10_{point['candidate_point_id']}_{shape_id}",
    ...
    info = {
        ...
        'strategy': 'one best stage1-positive seed per never-stage4-validated family through v9, expanded across a small trusted rf09 point cluster to improve point diversity before COMSOL validation',
    }
    return rows, info
