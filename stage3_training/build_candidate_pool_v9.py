...
OUT_DIR = ROOT / 'data' / 'ml_dataset' / 'v9' / 'candidate_pool_v9_seed_only_discovery'
POINT_MANIFEST = OUT_DIR / 'candidate_point_manifest.csv'
SEED_MANIFEST = OUT_DIR / 'candidate_seed_manifest.csv'
POOL_CSV = OUT_DIR / 'candidate_pool_v9.csv'
...
POINT_SPEC = {
    ...
    'point_strategy': 'v9_seed_only_discovery',
    'family_prior_source': 'stage1_positive_family_best_seed_excluding_all_stage4_validated_families_through_v8',
...
def build_candidate_pool(shape_df: pd.DataFrame, seed_manifest: List[Dict[str, object]]) -> Tuple[List[Dict[str, object]], Dict[str, object]]:
    ...
    for seed in seed_manifest:
        ...
        rows.append({
            'sample_id': f"candidate_pool_v9_{POINT_SPEC['candidate_point_id']}_{shape_id}",
            'source_stage': 'candidate_pool_v9',
    ...
    info = {
        ...
        'strategy': 'one best stage1-positive seed per never-stage4-validated family; no step neighborhood expansion',
    }
    return rows, info
