...
DEFAULT_SCORED_CSV = DEFAULT_OUT_ROOT / 'candidate_pool_seed_discovery_v9' / 'seed_discovery_predictions.csv'
DEFAULT_OUT_DIR = DEFAULT_OUT_ROOT / 'candidate_pool_seed_discovery_v9' / 'validation_manifest_v9'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Build v9 COMSOL validation manifest for seed-only family discovery.')
...
def sort_selection(df: pd.DataFrame) -> pd.DataFrame:
    ...
    return work.sort_values(
        ['cascade_gate', 'cascade_score', 'contact_prob', 'positive_prob_bucket', 'stage1_candidate_tier_rank', 'stage1_reference_gap_gain_Hz', 'surrogate_pred_gap34_gain_Hz', 'stage1_reference_contact_length'],
...
def main() -> None:
    ...
    manifest_csv = args.out_dir / 'comsol_validation_manifest_v9.csv'
    ordered_csv = args.out_dir / 'seed_only_candidates_for_validation_v9.csv'
    ...
    print('[DONE] validation manifest v9 built')
