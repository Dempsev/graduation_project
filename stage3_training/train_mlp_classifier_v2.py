...
DEFAULT_DATASETS = {
    'contact_valid': ROOT / 'data' / 'ml_dataset' / 'v2' / 'tasks' / 'parametric_contact_cls_v2.csv',
    'is_positive_shape': ROOT / 'data' / 'ml_dataset' / 'v2' / 'tasks' / 'parametric_positive_cls_v2.csv',
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train parameter-aware MLP classifiers for v2 tasks.')
...
def resolve_run_name(args: argparse.Namespace) -> str:
    ...
    return f'mlp_{args.task}_{args.feature_preset}_v2'
