...
DEFAULT_DATASETS = {
    'contact_valid': ROOT / 'data' / 'ml_dataset' / 'v5' / 'tasks' / 'parametric_contact_cls_v5.csv',
    'is_positive_shape': ROOT / 'data' / 'ml_dataset' / 'v5' / 'tasks' / 'parametric_positive_cls_v5.csv',
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train parameter-aware MLP classifiers for v5 tasks.')
...
def resolve_run_name(args: argparse.Namespace) -> str:
    ...
    return f'mlp_{args.task}_{args.feature_preset}_v5_full'
