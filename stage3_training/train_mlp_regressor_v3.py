...
DEFAULT_DATASET = ROOT / 'data' / 'ml_dataset' / 'v3' / 'tasks' / 'surrogate_regression_core_v3.csv'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train cleaned surrogate MLP regressor for v3 datasets.')
    ...
    parser.add_argument('--run-name', default='mlp_gap34_gain_surrogate_v3')
...
def main() -> None:
    ...
    if not feature_cols:
        raise RuntimeError('No usable feature columns found for regressor v3.')
