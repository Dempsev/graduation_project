...
DEFAULT_DATASET = ROOT / 'data' / 'ml_dataset' / 'v5' / 'tasks' / 'surrogate_regression_core_v5.csv'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train cleaned surrogate MLP regressor for v5 datasets.')
    ...
    parser.add_argument('--run-name', default='mlp_gap34_gain_surrogate_v5_full')
