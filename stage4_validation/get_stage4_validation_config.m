function cfg = get_stage4_validation_config()
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v1';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v1');
...
validationDir = fullfile(rootDir, 'data', 'ml_runs', 'candidate_pool_cascade_v1', 'validation_manifest_v1');
