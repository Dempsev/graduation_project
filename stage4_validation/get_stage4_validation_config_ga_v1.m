...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_ga_v1';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_ga_v1');
...
cfg.validationManifestCsv = fullfile(validationDir, 'ga_validation_manifest_v1.csv');
cfg.validationSummaryJson = fullfile(validationDir, 'ga_validation_manifest_summary.json');
