...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v10';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v10');
...
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v10.csv');
