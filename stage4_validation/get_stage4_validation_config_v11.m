...
%GET_STAGE4_VALIDATION_CONFIG_V11 Config for remaining-family v11 COMSOL validation runs.
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v11';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v11');
...
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v11.csv');
