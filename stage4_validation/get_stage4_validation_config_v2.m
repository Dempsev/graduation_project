function cfg = get_stage4_validation_config_v2()
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v2';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v2');
...
validationDir = fullfile(rootDir, 'data', 'ml_runs', 'candidate_pool_cascade_v2', 'validation_manifest_v2');
cfg.validationDir = validationDir;
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v1.csv');
...
cfg.configSignature = strjoin({ ...
    ...
    ['physics_profile=' char(string(cfg.physicsProfile))], ...
    ['target_profile=' char(string(cfg.targetProfile))], ...
    cfg.materialCase, ...
