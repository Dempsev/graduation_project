function cfg = get_stage4_validation_config_v3()
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v3';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v3');
...
validationDir = fullfile(rootDir, 'data', 'ml_runs', 'candidate_pool_cascade_v3', 'validation_manifest_v3');
cfg.validationDir = validationDir;
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v3.csv');
