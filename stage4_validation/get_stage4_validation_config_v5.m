function cfg = get_stage4_validation_config_v5()
%GET_STAGE4_VALIDATION_CONFIG_V5 Config for targeted v5 COMSOL validation runs.
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v5';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v5');
...
validationDir = fullfile(rootDir, 'data', 'ml_runs', 'candidate_pool_cascade_v5', 'validation_manifest_v5');
cfg.validationDir = validationDir;
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v5.csv');
