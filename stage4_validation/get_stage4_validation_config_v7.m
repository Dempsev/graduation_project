function cfg = get_stage4_validation_config_v7()
...
cfg = baseCfg;
cfg.validationId = 'stage4_validation_ab_v7';
cfg.outDir = fullfile(rootDir, 'data', 'comsol_batch', 'stage4_validation_ab_v7');
...
validationDir = fullfile(rootDir, 'data', 'ml_runs', 'candidate_pool_cascade_v7', 'validation_manifest_v7');
cfg.validationDir = validationDir;
cfg.validationManifestCsv = fullfile(validationDir, 'comsol_validation_manifest_v7.csv');
